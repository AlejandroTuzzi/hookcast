    ...
    <main className="dashboard-shell">
      <aside className="admin-sidebar">
        ...
        <nav aria-label="Admin navigation">
          ...
          <a href="#insights"><span>02</span> Insights <small>Soon</small></a>
          <a href="#security"><span>03</span> Security</a>
        </nav>
      ...
      <div className="admin-main">
        ...
        <section className="admin-panel future-panel" id="insights">
          <div className="panel-heading"><span>02</span><div><h2>Insights publishing</h2><p>The content model is reserved for articles, news and SEO landing pages.</p></div></div>
        ...
        <section className="admin-panel" id="security">
          <div className="panel-heading"><span>03</span><div><h2>Security</h2><p>Changing the password closes every other admin session.</p></div></div>
